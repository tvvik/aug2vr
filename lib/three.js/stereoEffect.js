...
*/
	...
	THREE.StereoEffect = function (renderer, plan1, plan2) {
		...
		this.render = function ( scene, camera, plane1, plane2) {
			...
			if (this.plan1) this.plan1.visible = true;
			if (this.plan2) this.plan2.visible = false;
			...
			if (this.plan1) this.plan1.visible = false;
			if (this.plan2) this.plan2.visible = true;
